...
import {IAttesterStatus} from "../../allForks/util";
import {CachedBeaconStatePhase0} from "../../types";
import {computeStartSlotAtEpoch, getBlockRootAtSlot} from "../../util";
...
export function statusProcessEpoch(
  ...
  for (const att of attestations) {
    ...
    const participants = att.aggregationBits.intersectYesValues(committee);
